...
def animate_mars(i):
    ...
    return animmars,
myAnimation1 = animation.FuncAnimation(fig,animate_merkur,frames=88,init_func=init_merkur,interval=25,blit=True)
myAnimation2 = animation.FuncAnimation(fig,animate_venera,frames=224,init_func=init_venera,interval=25,blit=True)
myAnimation3 = animation.FuncAnimation(fig,animate_zemlja,frames=365,init_func=init_zemlja,interval=25,blit=True)
myAnimation4 = animation.FuncAnimation(fig,animate_mars,frames=686,init_func=init_mars,interval=25,blit=True)
plt.show()
